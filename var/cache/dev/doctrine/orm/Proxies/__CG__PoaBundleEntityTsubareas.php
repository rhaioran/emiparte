 ...
 */
class Tsubareas extends \PoaBundle\Entity\Tsubareas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tsubareas $proxy) {
    ...
    public function getIdsubarea()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdsubarea();
        }
    ...
    public function setSubarea($subarea)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSubarea', [$subarea]);
    ...
    public function getSubarea()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSubarea', []);
